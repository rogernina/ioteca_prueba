app.controller("CategoriaCtrl", function($scope, API, $window, $mdDialog) {
    ...
    $scope.new = function(evt) {
        ...
        $mdDialog.show({
            scope: $scope,
            targetEvent: evt,
            templateUrl: 'build/catalogo/views/categoria/formd.html',
    ...
    $scope.new2 = function(evt) {
        ...
        $mdDialog.show({
            targetEvent: evt,
            scope: $scope,
            templateUrl: 'build/catalogo/views/categoria/formd2.html',
            preserveScope: true,
